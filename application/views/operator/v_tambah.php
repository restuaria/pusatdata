        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo base_url() . 'operator/proses_tambah_file/' ?>" enctype="multipart/form-data">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="keterangan" aria-label="Default select example" required>
                                    ...
                                    <?php
                                    foreach ($skon as $kon) { ?>
                                        <option value="<?php echo $kon->sub_arsip_id; ?>"><?php echo $kon->sub_arsip_nama; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
