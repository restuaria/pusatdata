            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group mb-1">
                        <form action="<?php echo base_url() . 'operator/standar3/' . $ts->sub_arsip_id; ?>" method="post">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('operator/tambah_file8/') ?>" class="btn btn-primary btn-sm mb-3 float-right"><i class="bi bi-plus"></i> TAMBAH DATA</a>
                    </div>
