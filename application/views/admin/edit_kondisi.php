<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('admin/kondisi_eksternal/') ?>">Kondisi Eksternal</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo base_url() . 'admin/proses_edit_file_kondisi/' . $me->arsip_id ?>" enctype="multipart/form-data">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="user" aria-label="Default select example" required>
