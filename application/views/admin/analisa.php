            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group mb-1">
                        <form action="<?php echo base_url() . 'admin/standar/' . $ts->sub_arsip_id; ?>" method="post">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('admin/tambah_analisa/') ?>" class="btn btn-primary btn-sm mb-3 float-right"><i class="bi bi-plus"></i> TAMBAH DATA</a>
                    </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-confirm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        ...
                                                        <a href="<?php echo base_url() . 'admin/hapus_standar/' . $p->arsip_id ?>" class="btn btn-danger">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-group">
                                            <a target="_blank" title="view" class="btn btn-primary" href="<?php echo base_url() . 'admin/viewpdf/' . $p->arsip_id ?>"><i class="bi bi-search"></i></a>
                                            <a href="<?php echo base_url() . 'admin/edit_analisa/' . $p->arsip_id ?>" title="edit" class="btn btn-warning"><i class="bi bi-pencil-square" style="color: white;"></i></a>
