        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group ">
                        <a href="<?php echo base_url('admin/tambah_file/') ?>" class="btn btn-primary btn-sm mb-3 float-right"><i class="bi bi-plus"></i> TAMBAH DATA</a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo base_url() . 'admin/edit/' . $p->arsip_id ?>" title="edit" class="btn btn-warning"><i class="bi bi-pencil-square" style="color: white;"></i></a>
