...
class Admin extends CI_Controller
{
    ...
    public function standar($sub_arsip_id)
    {
        $where1 = array('user_id' => $this->session->userdata("user_id"));
        $data['user'] = $this->m_admin->cek_login('user', $where1)->result();
        $data['title1'] = "C.1";
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar', $data);
        } elseif ($ts == "1") {
    ...
    public function standar2($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar2', $data);
        } elseif ($ts == "1") {
            $data['title1'] = "C.2";
            $data['title2'] = "Tata Pamong, Tata Kelola dan Kerjasama";
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar3($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
            $data['masuk'] = $this->m_admin->standar3($sub_arsip_id);
            $this->template->load('template', 'admin/standar3', $data);
        } elseif ($ts == "1") {
            $data['title1'] = "Standar 3";
            $data['title2'] = "Mahasiswa";
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar4($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar4', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar5($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar5', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar6($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar6', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar7($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar7', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar8($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar8', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function standar9($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/standar9', $data);
        } elseif ($ts == "1") {
            $data['ts'] = $this->db->query('SELECT * FROM sub_arsip WHERE sub_arsip_id =' . $sub_arsip_id)->row();
    ...
    public function analisa($sub_arsip_id)
    {
        ...
        if ($ts == "") {
            ...
            $this->template->load('template', 'admin/analisa', $data);
        } elseif ($ts == "1") {
    ...
    public function tambah()
    {
        ...
        $this->template->load('template', 'admin/v_tambah_all', $data);
    }
    ...
    public function proses_tambah_file()
    {
        ...
        if ($kategori == 103) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                redirect('admin/standar/' . $keterangan . '/?' . 'alert=berhasil');
            }
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar2/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 105) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar3/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 106) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar4/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 107) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar5/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 108) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar6/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 109) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar7/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 110) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar8/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 111) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/standar9/' . $keterangan . '?' . 'alert=berhasil');
            }
        } elseif ($kategori == 112) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/analisa/' . $keterangan . '?' . 'alert=berhasil');
            }
        }
    }
    ...
    public function proses_edit($arsip_id)
    {
        ...
        if ($kategori == 103) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                redirect('admin/standar/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 104) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar2/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 105) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar3/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 106) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar4/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 107) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar5/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 108) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar6/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 109) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar7/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 110) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar8/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 111) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/standar9/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
        ...
        elseif ($kategori == 112) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/analisa/' . $keterangan . '/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
    ...
    public function sub_arsip()
    {
        ...
        $this->template->load('template', 'admin/sub_arsip', $data);
    }
    function tambah_sub_arsip()
    {
        ...
        redirect('admin/sub_arsip/?' . 'alert=berhasil');
    }
    ...
    function hapus_sub_arsip($sub_arsip_id)
    {
        ...
        redirect('admin/sub_arsip/?' . 'alert=hapus');
    }
    ...
    function update()
    {
        ...
        redirect('admin/pass/?' . 'alert=sukses');
    }
    public function all()
    {
        $where1 = array('user_id' => $this->session->userdata("user_id"));
    ...
    public function kondisi_eksternal()
    {
        ...
        $this->template->load('template', 'admin/kon_eks', $data);
    }
    ...
    function tambah_file_kondisi()
    {
        ...
        $this->template->load('template', 'admin/v_tambah_kon', $data);
    }
    function proses_tambah_file_kondisi()
    {
        ...
        if ($kategori == 101) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/kondisi_eksternal/?' . 'alert=berhasil');
            }
        } elseif ($kategori == 102) {
            $config['upload_path']          = './file/arsip';
            $config['allowed_types']        = 'PDF|pdf';
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->insert('arsip', $data);
                redirect('admin/instansi/?' . 'alert=berhasil');
            }
        }
    }
    public function edit_kondisi($arsip_id)
    {
        ...
        $this->template->load('template', 'admin/edit_kondisi', $data);
    }
    function proses_edit_file_kondisi($arsip_id)
    {
        ...
        if ($kategori == 101) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/kondisi_eksternal/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                $this->db->where('arsip_id', $arsip_id);
                $this->db->update('arsip', $data);
                redirect('admin/instansi/?' . 'alert=update');
            } else {
                $data_gambar = $this->upload->data();
                $data = [
                    'arsip_waktu_upload' => $tgl,
    ...
    public function instansi()
    {
        ...
        $this->template->load('template', 'admin/v_instansi', $data);
    }
    ...
    function viewpdf($id)
    {
        ...
        $this->template->load('template', 'admin/v_pdf', $data);
    }
    function kategori()
    {
        $where1 = array('user_id' => $this->session->userdata("user_id"));
